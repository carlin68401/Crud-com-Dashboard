  ...
  <a class="navbar-brand navbar-brand-text" href="#">Sua Empresa</a>
   ...
   <div class="container">
      <div class="text-center mb-4">
         <h3>Adicione o Funcionário Abaixo</h3>
         <p class="text-muted">Complete as informações sobre o mesmo:</p>
      </div>
 <!-- formulario -->
      <div class="container d-flex justify-content-center">
         <form action="../controller/controller_cadastro_fun.php" method="POST" style="width:50vw; min-width:300px;">
            <div class="row mb-3">
               <div class="col">
               ...
               <div class="col">
                  ...
                  <input type="text" class="form-control" name="telefone" placeholder="1999555-1789">
               </div>
            </div>

            <div class="mb-3">
               <label class="form-label">Função</label>
               <input type="text" class="form-control" name="funcao" placeholder="Estagiário">
            </div>

            <div class="mb-3">
               <label class="form-label">Salário</label>
               <input type="text" class="form-control" name="salario" placeholder="4.000">
            </div>
